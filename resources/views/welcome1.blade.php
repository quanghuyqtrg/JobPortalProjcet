            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div class="border-b border-gray-200 px-8 py-6">
                    <div class="flex justify-between items-center">
                        ...
                        <a href="{{ route('recruiter.jobs.index') }}" class="text-gray-500 hover:text-gray-700">
                            <i class="fas fa-times text-2xl"></i>
                        </a>
                    </div>
                </div>
                <!-- End Header Section -->
                <form action="{{ route('recruiter.jobs.store') }}" method="POST" class="p-8">
                    @csrf
                    ...
                    <div class="mb-8">
                        <label for="description" class="block text-sm font-medium text-gray-700 mb-2">
                            Add your job description <span class="text-red-500">*</span>
                        </label>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="flex flex-wrap items-center gap-2">
                            ...
                            <div
                                ...
                                Figma
                                <button type="button" class="ml-2 text-green-500 hover:text-green-700">
                                    <i class="fas fa-times"></i>
                                </button>
                            </div>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="flex items-center gap-4">
                            <div
                                class="border-2 border-dashed border-blue-300 rounded-xl p-6 flex flex-col items-center justify-center w-32 h-28 bg-blue-50 cursor-pointer hover:bg-blue-100 transition-colors">
                                <i class="fas fa-plus text-blue-500 text-2xl mb-1"></i>
                                <span class="text-xs text-blue-600">Upload File</span>
                            </div>
                            <div class="flex items-center">
                                <i class="fas fa-file-pdf text-red-500 mr-2"></i>
                                <span class="text-sm text-blue-600 mr-2">Job_required.pdf</span>
